...
def click_info():
    ...
    **Returns**
    ...
    wat_but = Button(out_frame, text='Watch Now', command=partial(click_watch, mov1, clicked))
...
def click_rec_info(recs, j):
    ...
    **Returns**
    ...
    wat_but = Button(top_frame, text='Watch Now', command=partial(click_watch, mov2, clicked))
...
def click_rec():
    ...
    **Returns**
    ...
    for j in range(len(recs) - 1):
        Button(out_frame, text='Get Info', command=partial(click_rec_info, recs, j)).grid(row=12 + j, column=10, sticky=W)
...
info_but = Button(in_frame, text='Get Info', padx=5, command=click_info, fg='blue')
